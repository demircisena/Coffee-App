  ...
  return (
    ...
    >
      <Tab.Screen
        ...
        component={Cart}
        options={{
          tabBarIcon: ({ color }) => <EvilIcons name="cart" size={32} color={color} />,
        }}
      />
      <Tab.Screen
        name="Orders"
      ...
      <Tab.Screen
        ...
        component={Location}
        options={{
          tabBarIcon: ({ color }) => <EvilIcons name="location" size={32} color={color} />,
        }}
      />
      <Tab.Screen
        name="Account"
        component={Account}
        options={{
          tabBarIcon: ({ color, size }) => <FontAwesome5 name="user" size={21} color={color} />,
        }}
      />
    </Tab.Navigator>
  );
